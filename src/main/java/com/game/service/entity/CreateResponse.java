...
public class CreateResponse {
    ...
    public CreateResponse(Long id, String name, String title, Race race, Profession profession, Long birthday, Boolean banned, Integer experience, Integer level, Integer untilNextLevel) {
        this.id = id;
        this.name = name;
        this.title = title;
        this.race = race;
    ...
    public String toString() {
        return "CreateNewPlayerResponse{" +
                "id=" + id +
                ", name='" + name + '\'' +
                ", title='" + title + '\'' +
                ", race=" + race +
